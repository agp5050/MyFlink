...
public class DoubleCounterCode {
    public static void main(String[] args) throws Exception {
        ...
        MapOperator<String, String> map = dataSource.map(new RichMapFunction<String, String>() {
            ...
            //1.创建累加器,在算子中创建累加器对象
            private DoubleCounter numLines = new DoubleCounter();
        ...
        JobExecutionResult myJobExecutionResult = env.execute("DoubleCounterTest");
        //4.当作业执行完成之后，在JobExecutionResult对象中获取累加器的值。
        Double accumulatorResult = myJobExecutionResult.getAccumulatorResult("num-lines");
